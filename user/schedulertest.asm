...
int main()
{
  ...
  42:	88a50513          	addi	a0,a0,-1910 # 8c8 <malloc+0x100>
  46:	00000097          	auipc	ra,0x0
  4a:	6ca080e7          	jalr	1738(ra) # 710 <printf>
    exit(0);
  4e:	4501                	li	a0,0
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 47e:	4ce50513          	addi	a0,a0,1230 # 948 <digits>
 482:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 53e:	3b6c8c93          	addi	s9,s9,950 # 8f0 <malloc+0x128>
 ...
 54c:	400b8b93          	addi	s7,s7,1024 # 948 <digits>
 ...
 672:	27a98993          	addi	s3,s3,634 # 8e8 <malloc+0x120>
        while(*s != 0){
 676:	85ee                	mv	a1,s11
