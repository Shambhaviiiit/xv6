...
putc(int fd, char c)
{
 ...
 37e:	f3e080e7          	jalr	-194(ra) # 2b8 <write>
}
...
malloc(uint nbytes)
{
 ...
 7d4:	b50080e7          	jalr	-1200(ra) # 320 <sbrk>
  if(p == (char*)-1)
